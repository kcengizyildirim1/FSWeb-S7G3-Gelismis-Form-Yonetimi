          ...
          <div className="mt-10 flex flex-col">
            <div className="mb-10">
              ...
              {formErrors.first_name && (
                <div className="text-red-600">{formErrors.first_name}</div>
              )}
            </div>
            ...
            <div className="mb-10">
              ...
              {formErrors.last_name && (
                <div className="text-red-600">{formErrors.last_name}</div>
              )}
            </div>
            <div className="mb-10">
              <label
            ...
            <div className="sm:col-span-4 mt-10 w-1/2 mx-auto">
              ...
              {formErrors.gender && (
                <div className="text-red-600">{formErrors.gender}</div>
              )}
            </div>
            <div className="sm:col-span-4 mt-10 w-1/2 mx-auto">
              ...
              {formErrors.agreement && (
                <div className="text-red-600">{formErrors.agreement}</div>
              )}
            </div>
          </div>
        </div>
